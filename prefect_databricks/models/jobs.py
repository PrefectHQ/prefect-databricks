...
#   timestamp: 2022-06-29T19:47:32+00:00
...
class AutoScale(BaseModel, extra=Extra.allow):
    class Config:
...
class AwsAttributes(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class ClusterInstance(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class ClusterSize(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class ClusterTag(BaseModel, extra=Extra.allow):
    """
...
class CronSchedule(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class DbfsStorageInfo(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class DockerBasicAuth(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class DockerImage(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class FileStorageInfo(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class GitSnapshot(BaseModel, extra=Extra.allow):
    """
...
class GitSource1(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class JobEmailNotifications(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class LogSyncStatus(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class MavenLibrary(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class NotebookOutput(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class NotebookTask(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class ParameterPair(BaseModel, extra=Extra.allow):
    """
...
class PermissionLevel(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class PermissionLevelForGroup(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class PipelineTask(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class PythonPyPiLibrary(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class PythonWheelTask(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class RCranLibrary(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class RepairRunInput(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class RunNowInput(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
    ...
    idempotency_token: Optional[str] = Field(
        ...
        description=(
            ...
            ' new run but returns the ID of the existing run instead.\n\nIf you specify'
            ' the idempotency token, upon failure you can retry until the request'
            ' succeeds. Databricks guarantees that exactly one run is launched with'
            ' that idempotency token.\n\nThis token must have at most 64'
...
class RunParameters(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class RunState(BaseModel, extra=Extra.allow):
    """
...
class S3StorageInfo(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class SparkConfPair(BaseModel, extra=Extra.allow):
    """
...
class SparkEnvPair(BaseModel, extra=Extra.allow):
    """
...
class SparkJarTask(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class SparkNodeAwsAttributes(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class SparkPythonTask(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class SparkSubmitTask(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class SparkVersion(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class TaskDependency(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class TaskDependencies(BaseModel, extra=Extra.allow):
    """
...
class TaskDescription(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class TaskKey(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class TerminationParameter(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class AccessControlRequestForGroup(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class AccessControlRequestForServicePrincipal(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class AccessControlRequestForUser(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class ClusterCloudProviderNodeInfo(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class ClusterLogConf(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class InitScriptInfo(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class JobTask(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class Library(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class LibraryFullStatus(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class NodeType(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class RepairHistoryItem(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class RunSubmitTaskSettings(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class RunTask(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class SparkNode(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class TerminationReason(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class ViewItem(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class AccessControlRequest(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class ClusterAttributes(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class ClusterInfo(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class ClusterLibraryStatuses(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class ClusterSpec(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class EventDetails(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class JobCluster(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class JobTaskSettings(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class RepairHistory(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class RunSubmitSettings(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
    ...
    idempotency_token: Optional[str] = Field(
        ...
        description=(
            ...
            ' does not create a new run but returns the ID of the existing run'
            ' instead.\n\nIf you specify the idempotency token, upon failure you can'
            ' retry until the request succeeds. Databricks guarantees that exactly one'
            ' run is launched with that idempotency token.\n\nThis token must have at'
...
class ClusterEvent(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
...
class JobSettings(BaseModel, extra=Extra.allow):
    class Config:
        allow_mutation = False
