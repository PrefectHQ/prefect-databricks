...
OpenAPI spec: account-2.0-aws.yaml
Updated at: 2022-06-29T19:47:26.128936
"""
...
if TYPE_CHECKING:
    ...
    from prefect_databricks.models import accounts as models
...
async def get_credential_configs(
    ...
    responses = {
        ...
        401: (  # noqa
            "The request is unauthenticated. The user's credentials are missing or"
            " incorrect."
        ),
...
@task
async def create_credential_config(
    account_id: str,
    databricks_credentials: "DatabricksCredentials",
...
@task
async def delete_credential_config(
    account_id: str,
    credentials_id: str,
    databricks_credentials: "DatabricksCredentials",
) -> Dict[str, Any]:
...
async def create_network_config(
    ...
    vpc_endpoints: Union["models.NetworkVpcEndpoints", Dict] = None,
) -> Dict[str, Any]:
    """
...
@task
async def create_key_config(
    account_id: str,
    databricks_credentials: "DatabricksCredentials",
    aws_key_info: Union["models.CreateAwsKeyInfo", Dict] = None,
    use_cases: List = None,
) -> Dict[str, Any]:
    """
...
@task
async def get_key_workspace_history(
    account_id: str,
    databricks_credentials: "DatabricksCredentials",
) -> Dict[str, Any]:
    """
...
@task
async def get_log_delivery_configs(
    account_id: str,
    databricks_credentials: "DatabricksCredentials",
    status: str = None,
    credentials_id: str = None,
...
@task
async def create_log_delivery_config(
...
@task
async def get_log_delivery_config(
    account_id: str,
...
@task
async def patch_log_delivery_config_status(
    account_id: str,
    log_delivery_configuration_id: str,
    databricks_credentials: "DatabricksCredentials",
    status: Union["models.LogDeliveryConfigStatus", Dict] = None,
) -> Dict[str, Any]:
    """
...
@task
async def download_billable_usage(
    start_month: str,
    end_month: str,
    account_id: str,
    databricks_credentials: "DatabricksCredentials",
...
async def create_budget(
    ...
    account_id: str,
    databricks_credentials: "DatabricksCredentials",
    budget: Union["models.BudgetCreateRequest", Dict] = None,
) -> Dict[str, Any]:
    """
...
@task
async def get_private_access_settings_objects(
    account_id: str,
    databricks_credentials: "DatabricksCredentials",
) -> Dict[str, Any]:
    """
...
@task
async def create_private_access_settings(
    account_id: str,
    databricks_credentials: "DatabricksCredentials",
    ...
    allowed_vpc_endpoint_ids: List = None,
) -> Dict[str, Any]:
    """
...
@task
async def get_private_access_settings_object(
    account_id: str,
...
@task
async def delete_private_access_settings_object(
    account_id: str,
    private_access_settings_id: str,
    databricks_credentials: "DatabricksCredentials",
) -> Dict[str, Any]:
...
@task
async def replace_private_access_settings(
    account_id: str,
    private_access_settings_id: str,
    databricks_credentials: "DatabricksCredentials",
    private_access_settings_name: str = None,
...
@task
async def get_vpc_endpoint_config(
    account_id: str,
    vpc_endpoint_id: str,
    databricks_credentials: "DatabricksCredentials",
) -> Dict[str, Any]:
